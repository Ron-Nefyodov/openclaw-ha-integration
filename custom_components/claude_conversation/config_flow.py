"""Config flow for Claude Conversation integration."""
...
class ClaudeConversationConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Claude Conversation."""
...
class ConversationSubentryFlowHandler(ConfigSubentryFlow):
    ...
    async def async_step_set_options(
        ...
        schema = self.add_suggested_values_to_schema(
            vol.Schema(
                _config_option_schema(self.hass, self._is_new, options)
            ),
            suggested_values,
        )
...
def _config_option_schema(
    ...
    """Return a schema for Claude conversation options."""
    ...
    schema.update(
        {
            ...
            vol.Optional(CONF_THINKING_BUDGET, default=RECOMMENDED_THINKING_BUDGET): int,
        }
    )
    return schema
